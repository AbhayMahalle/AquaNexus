...
const ROLE_HEADERS: { key: RoleKey; label: string; color: string }[] = [
  ...
  { key: 'manager', label: 'Manager', color: '#0C3E6B' },
  ...
  return (
    <AuthGuard allowedRoles={['admin']}>
      <DashboardLayout>
          ...
          <CardContent className="p-0">
            <div className="w-full overflow-x-auto">
              <table className="w-full text-left border-collapse min-w-full">
                <thead>
                  <tr className="bg-[#F5F8FB] border-b border-[#E2E8F0]">
                    <th className="px-4 py-3 text-xs font-bold uppercase tracking-wider text-[#64748B] min-w-[240px] whitespace-nowrap">
                ...
                <tbody className="divide-y divide-[#E2E8F0]">
                  {matrix.map((row, rowIdx) => (
                    <tr key={rowIdx} className="hover:bg-[#F5F8FB] transition-colors">
                            ...
                            <button
                              ...
                              className={`inline-flex items-center justify-center w-8 h-8 rounded-lg transition-all ${
                                val
                                  ...
                                  : 'bg-[#EFF3F8] text-[#94A3B8] border border-[#E2E8F0] hover:bg-[#E2E8F0] hover:text-[#172033]'
        ...
        <div className="mt-4 p-4 rounded-xl bg-[#F5F8FB] border border-[#E2E8F0]">
