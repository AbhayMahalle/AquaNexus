      ...
      <DashboardLayout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          {assignments.includes('store') && (
            <Card variant="interactive" className="border-t-4 border-t-[#64748B]">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-base flex items-center gap-2">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-[#F5F8FB] border border-[#E2E8F0]">
              ...
              <p className="text-xs text-[#64748B] mt-1">Sufficient cap stock and preforms loaded for ongoing shift operations.</p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-[#F5F8FB] border border-[#E2E8F0]">
              ...
              <p className="text-xs text-[#64748B] mt-1">Delivery vehicles dispatched for Kothrud, Hadapsar, and Viman Nagar routes.</p>
            </div>
          </CardContent>
        </Card>
      </DashboardLayout>
